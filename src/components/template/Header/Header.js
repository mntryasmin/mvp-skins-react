...
import Menu from '../../micro/Menu/Menu.js'
import logoClean from '../../../assets/images/ID/logo-mvp.png'
    ...
    return (
        <>
            <header>
                ...
                <Container fluid className="topo-header py-0 m-0">
                    ...
                    <Col xs={8} md={6} >
                        <Form >
                            <Form.Group className="d-flex ">
                                ...
                                <a href="#" >
                                    <img src={Lupa} height="40" className="lupa" />
                                </a>
                            </Form.Group>
                        </Form>
                    </Col>
                    ...
                    <Col xs={12} md={4} className="btn-menu">
                        {/* BOTÃO DE LOGIN */}
                        <LoginModal />
